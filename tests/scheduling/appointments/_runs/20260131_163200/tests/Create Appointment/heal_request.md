...
> **Generated**: 2026-01-31T16:33:25.751184
> **Test Type**: test
> **Duration**: 21813ms
**Status**: `open`
...
Call log:
  - waiting for locator("iframe[title=\"angularjs\"]").content_frame.locator("#vue_iframe_layout").content_frame.get_by_role("textbox", name=re.compile(r"Address", re.IGNORECASE)).first to be visible
...
Screenshot saved at: `.temp_screenshots\create_appointment_20260131_163325.png`
