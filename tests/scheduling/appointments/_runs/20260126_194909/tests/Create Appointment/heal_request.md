...
> **Generated**: 2026-01-26T19:50:27.625020
> **Test Type**: test
> **Duration**: 29612ms
**Status**: `open`
...
Call log:
  - waiting for locator("iframe[title=\"angularjs\"]").content_frame.locator("#vue_iframe_layout").content_frame.locator("[data-qa=\"multi-booking-modal-Schedule appointment\"]").or_(get_by_role("button", name="Schedule appointment"))
...
Screenshot saved at: `.temp_screenshots\create_appointment_20260126_195027.png`
