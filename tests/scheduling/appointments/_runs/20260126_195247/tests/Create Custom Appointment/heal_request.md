...
> **Generated**: 2026-01-26T19:54:38.856180
> **Test Type**: test
> **Duration**: 15464ms
**Status**: `open`
...
Call log:
  - waiting for locator("iframe[title=\"angularjs\"]").content_frame.locator("#vue_iframe_layout").content_frame.get_by_role("button", name="Schedule appointment") to be visible
...
Screenshot saved at: `.temp_screenshots\create_custom_appointment_20260126_195438.png`
