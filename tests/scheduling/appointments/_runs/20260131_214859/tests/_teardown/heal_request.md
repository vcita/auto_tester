...
> **Generated**: 2026-01-31T21:53:10.135949
> **Test Type**: teardown
> **Duration**: 55942ms
**Status**: `open`
...
Call log:
  - waiting for locator("iframe[title=\"angularjs\"]").content_frame.get_by_role("button").filter(has_text="Appointment Test Service 1769888968") to be visible
...
Screenshot saved at: `.temp_screenshots\_teardown_20260131_215309.png`
