...
> **Generated**: 2026-01-31T19:59:33.711950
> **Test Type**: teardown
> **Duration**: 47737ms
**Status**: `open`
...
Call log:
  - waiting for locator("iframe[title=\"angularjs\"]").content_frame.get_by_text(re.compile(r"^Delete ", re.IGNORECASE)).first to be visible
...
Screenshot saved at: `.temp_screenshots\_teardown_20260131_195933.png`
