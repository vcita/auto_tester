...
> **Generated**: 2026-01-31T20:04:17.772466
> **Test Type**: teardown
> **Duration**: 76226ms
**Status**: `open`
...
Call log:
  - waiting for locator("iframe[title=\"angularjs\"]").content_frame.get_by_role("button").filter(has_text="Appointment Test Service 1769882446") to be visible
...
Screenshot saved at: `.temp_screenshots\_teardown_20260131_200417.png`
