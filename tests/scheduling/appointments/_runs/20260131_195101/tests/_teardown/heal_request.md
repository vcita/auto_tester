...
> **Generated**: 2026-01-31T19:54:39.629148
> **Test Type**: teardown
> **Duration**: 55900ms
**Status**: `open`
...
Call log:
  - waiting for locator("iframe[title=\"angularjs\"]").content_frame.get_by_role("menu").get_by_text(re.compile(r"^Delete ", re.IGNORECASE)) to be visible
...
Screenshot saved at: `.temp_screenshots\_teardown_20260131_195439.png`
