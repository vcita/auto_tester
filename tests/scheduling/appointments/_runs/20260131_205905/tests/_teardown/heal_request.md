...
> **Generated**: 2026-01-31T21:02:47.388206
> **Test Type**: teardown
> **Duration**: 37497ms
**Status**: `open`
...
Call log:
  - waiting for locator("iframe[title=\"angularjs\"]").content_frame.get_by_role("dialog").filter(has_text=re.compile(r"delete", re.IGNORECASE)).get_by_role("button").filter(has_text=re.compile(r"^(Delete|O[kK])$", re.IGNORECASE)).first to be visible
...
Screenshot saved at: `.temp_screenshots\_teardown_20260131_210247.png`
