...
> **Generated**: 2026-01-27T12:26:06.278020
> **Test Type**: teardown
> **Duration**: 0ms
**Status**: `open`
...
```
Error loading C:\Programming\auto_tester\tests\scheduling\events\_teardown\test.py: IndentationError: unexpected indent (test.py, line 88)
```
