...
> **Generated**: 2026-01-24T17:43:31.859006
> **Test Type**: test
> **Duration**: 613ms
**Status**: `open`
...
```
ValueError: Remove button not found for attendee 'Event TestClient1769269347'. Found 0 buttons in parent.
```
...
Screenshot saved at: `.temp_screenshots\remove_attendee_20260124_174331.png`
