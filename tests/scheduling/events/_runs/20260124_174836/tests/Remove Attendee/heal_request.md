...
> **Generated**: 2026-01-24T17:49:57.767545
> **Test Type**: test
> **Duration**: 617ms
**Status**: `open`
...
```
ValueError: Remove button not found for attendee 'Event TestClient1769269734'. Searched 0 buttons in attendees section.
```
...
Screenshot saved at: `.temp_screenshots\remove_attendee_20260124_174957.png`
