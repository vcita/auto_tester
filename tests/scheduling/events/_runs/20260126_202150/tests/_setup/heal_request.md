...
> **Generated**: 2026-01-26T20:22:35.975520
> **Test Type**: setup
> **Duration**: 27715ms
**Status**: `open`
...
```
AssertionError: Setup could not confirm group event service was created: 'Event Test Workshop 1769451728' not found on Services page. Create dialog closed but service may not have been saved. Check run video/screenshot.
```
...
Screenshot saved at: `.temp_screenshots\_setup_20260126_202235.png`
