...
> **Generated**: 2026-01-24T18:26:58.193076
> **Test Type**: test
> **Duration**: 10693ms
**Status**: `open`
...
Call log:
  - waiting for locator("iframe[title=\"angularjs\"]").content_frame.locator("#vue_iframe_layout").content_frame.get_by_text("Event TestClient1769271941").locator("..").locator("..").locator("button").nth(1) to be visible
...
Screenshot saved at: `.temp_screenshots\remove_attendee_20260124_182658.png`
