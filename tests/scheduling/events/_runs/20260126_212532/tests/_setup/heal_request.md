...
> **Generated**: 2026-01-26T21:26:30.355819
> **Test Type**: setup
> **Duration**: 36791ms
**Status**: `open`
...
```
AssertionError: Setup could not confirm group event service was created: 'Event Test Workshop 1769455553' not found on Services page. Create dialog closed but service may not have been saved. Check run video/screenshot.
```
...
Screenshot saved at: `.temp_screenshots\_setup_20260126_212630.png`
