...
> **Generated**: 2026-01-24T17:39:38.221185
> **Test Type**: test
> **Duration**: 8193ms
**Status**: `open`
...
```
ValueError: Attendee 'Event TestClient1769269100' was not removed. Still found 1 instance(s).
```
...
Screenshot saved at: `.temp_screenshots\remove_attendee_20260124_173938.png`
