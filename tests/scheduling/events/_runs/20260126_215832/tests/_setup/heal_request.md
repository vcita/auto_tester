...
> **Generated**: 2026-01-26T21:59:30.135492
> **Test Type**: setup
> **Duration**: 34363ms
**Status**: `open`
...
```
AssertionError: Setup could not confirm group event service was created: 'Event Test Workshop 1769457535' not found on Services page. Create dialog closed but service may not have been saved. Check run video/screenshot.
```
...
Screenshot saved at: `.temp_screenshots\_setup_20260126_215929.png`
