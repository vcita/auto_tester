...
> **Generated**: 2026-01-26T22:43:01.828524
> **Test Type**: setup
> **Duration**: 33597ms
**Status**: `open`
...
```
AssertionError: Setup could not confirm group event service was created: 'Event Test Workshop 1769460148' not found on Services page. Create dialog closed but service may not have been saved. Check run video/screenshot.
```
...
Screenshot saved at: `.temp_screenshots\_setup_20260126_224301.png`
