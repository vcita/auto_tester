...
> **Generated**: 2026-01-26T20:21:31.808018
> **Test Type**: setup
> **Duration**: 19701ms
**Status**: `open`
...
```
AssertionError: Setup could not confirm group event service was created: 'Event Test Workshop 1769451671' not found on Services page. Create dialog closed but service may not have been saved. Check run video/screenshot.
```
...
Screenshot saved at: `.temp_screenshots\_setup_20260126_202131.png`
