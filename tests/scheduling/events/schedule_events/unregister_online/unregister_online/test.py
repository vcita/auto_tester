# Source: tests/scheduling/events/schedule_events/unregister_online/unregister_online/script.md
# Migrated from automation-js/features/tempo/scheduling-events.feature scenario 2 (VCITA2-14026)
...
def test_unregister_online(page: Page, context: dict) -> None:
    """Register three clients, unregister one from the back office and one from the client
    portal, then record an online payment for the last attendee - asserting the attendee
    ...
    print("  Step 5: Record an online $100 payment for nir")
    pay_for_attendee_bo(page, context, event_uid, "nir karpin", "100", pos=False)
    _assert_attendees(page, context, event_uid, [
        {"name": "silvan goodbye", "payment_status": "unpaid", "state": "unregistered",
    ...
    print("  [OK] unregister from BO + CP and online payment verified")
