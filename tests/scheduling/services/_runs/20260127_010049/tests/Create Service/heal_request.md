...
> **Generated**: 2026-01-27T01:03:49.152662
> **Test Type**: test
> **Duration**: 0ms
**Status**: `open`
...
```
ValueError: Expected to be on Services page, but URL is https://app.vcita.com/app/event-list
```
...
Screenshot saved at: `.temp_screenshots\create_service_20260127_010348.png`
