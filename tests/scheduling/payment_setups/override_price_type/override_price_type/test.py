...
from tests.scheduling.payment_setups.payment_setups_common import APPT_FEE_TYPE
from tests.scheduling.payment_setups.payment_setups_ui import read_meeting_price
