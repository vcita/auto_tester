...
> **Generated**: 2026-01-27T15:12:34.861388
> **Test Type**: test
> **Duration**: 0ms
**Status**: `open`
...
```
ValueError: No created_matter_id in context - create_matter test must run first
```
...
Screenshot saved at: `.temp_screenshots\add_note_20260127_151233.png`
