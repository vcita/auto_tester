...
from tests.clients.crm_tabs_management.crm_tabs_helpers import (
...
from tests.clients.crm_views.crm_views_helpers import close_tab, open_clients_list, select_view
