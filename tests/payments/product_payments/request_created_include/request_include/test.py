# Source: tests/payments/product_payments/request_created_include/request_include/script.md
...
def test_request_include(page: Page, context: dict) -> None:
    """Assign a product with two taxes via the client card and assert the payment
    request is DUE $10.00 (inclusive mode, tax included in price)."""
    ...
    print("  Step 2: Product payment request is DUE $10.00")
    ...
    print("  [OK] product payment request created (tax include) verified")
