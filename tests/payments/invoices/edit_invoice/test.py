...
def test_edit_invoice(page: Page, context: dict) -> None:
    ...
    save_button.wait_for(state="visible", timeout=45000)
    save_button.click()
    ...
    updated_heading.wait_for(state="visible", timeout=45000)
