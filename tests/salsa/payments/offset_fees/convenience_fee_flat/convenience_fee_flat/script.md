...
## 1. Enable convenience fee - flat (POV Online Payments tab)
- `enable_convenience_fee(page, context, "flat", "1")`
...
- Format percentage activated first `...fee-format-item-1`, then flat `...fee-format-item-0`
- Fee input `[data-qa="online-payments-tab-offset-card-fees-fee-input"] input`
  (falls back to `.offset-card-fees input[type='number']`) -> `1`
...
- Fee badge `.payment-method-card.selected .payment-method-card__fee-badge` == `+ $1.00` (whitespace-normalized)
- Summary `.summary` contains `Convenience fee` and `$1.00`
...
- Success `.done-loading[data-qa='payment-success-page']`; title `span.briliant`;
  amount `span.paymet-text` contains `$101.00`

## 4. Back Office (`/app/payments/transactions`)
- `assert_back_office_payment(page, context, "$101.00", "$1.00", [service])`
