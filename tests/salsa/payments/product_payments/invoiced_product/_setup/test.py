"""Setup for the "user pays for an invoiced product" scenario.

Mirrors the products.feature Background plus the scenario's "assigns a product to
client via API" Given. The assigned (DUE) product order is what the invoice is
created from.
"""
...
def setup_invoiced(page: Page, context: dict) -> None:
