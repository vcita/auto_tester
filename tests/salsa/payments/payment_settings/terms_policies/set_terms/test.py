...
from tests.salsa.payments.payment_settings.payment_settings_api import (
    get_terms_and_policies,
    set_terms_and_policies,
)
from tests.salsa.payments.payment_settings.payment_settings_ui import read_terms_text
