...
> **Generated**: 2026-01-24T22:49:31.597028
> **Test Type**: test
> **Duration**: 7396ms
**Status**: `open`
...
```
ValueError: Client 'Event TestClient1769287683' not found in search results. Searched 27 buttons.
```
...
Screenshot saved at: `.temp_screenshots\add_attendee_20260124_224930.png`

**Analyze the screenshot to understand the UI state at failure.**

## Context Summary

Context had 10 keys: created_client_email, created_client_id, created_client_name, event_client_email, event_client_id, event_client_name, event_group_service_name, logged_in_user, scheduled_event_id, scheduled_event_time
